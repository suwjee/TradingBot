...
paths.warning = 'M12 3 2.5 20h19L12 3zm0 6v5m0 3v.01';
paths.external = 'M14 5h5v5m0-5-9 9M19 13v6H5V5h6';
paths.refresh = 'M20 11a8 8 0 1 0-2.34 5.66M20 4v7h-7';
paths.line = 'M4 19L20 5';
paths.chartSettings = paths.settings;
...
paths.importExport = 'M7 3v8m0-8L4 6m3-3 3 3M17 21v-8m0 8-3-3m3 3 3-3M4 13h16';
...
paths.terminal = 'M5 7l5 5-5 5m7 0h7';
paths.account_tree = 'M6 4h5v5H6zM13 15h5v5h-5zM6 15h5v5H6zM8.5 9v3.5H15V15m-6.5-2.5V15';
